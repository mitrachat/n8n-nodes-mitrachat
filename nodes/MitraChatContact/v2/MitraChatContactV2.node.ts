...
export class MitraChatContactV2 implements INodeType {
  description: INodeTypeDescription = {
    ...
    description: "Enrich and sync MitraChat contact records. Supports v2 error envelope.",
    ...
    properties: [
      ...
      },
      {
        ...
        options: [
          { name: "Get", value: "get", description: "Resolve a contact by ID, phone, or email", action: "Get a contact" },
          { name: "Upsert", value: "upsert", description: "Create or update a contact", action: "Upsert a contact" },
          { name: "Add Tags", value: "addTags", description: "Add tags to a contact", action: "Add contact tags" },
          { name: "Remove Tags", value: "removeTags", description: "Remove tags from a contact", action: "Remove contact tags" },
          { name: "Add Note", value: "addNote", description: "Add a note to a contact", action: "Add a contact note" },
          { name: "Update Metadata", value: "updateMetadata", description: "Merge metadata into a contact", action: "Update contact metadata" },
        ],
        default: "get",
      },
      {
        ...
        displayOptions: { show: { operation: ["get", "addTags", "removeTags", "addNote", "updateMetadata"] } },
      },
      {
        displayName: "Phone",
        name: "phone",
      ...
      },
      {
        ...
        displayOptions: { show: { operation: ["upsert", "updateMetadata"] } },
      },
      {
        displayName: "Tags",
        name: "tags",
      ...
      },
      {
        ...
        displayOptions: { show: { operation: ["addNote"] } },
      },
    ],
  };
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let i = 0; i < items.length; i++) {
      ...
      if (response.ok === false) {
        throw new Error(`MitraChat Contact API error: ${parseErrorEnvelope(response)}`);
      }
